...
import com.ozius.internship.project.domain.exception.IllegalPriceException;
...
public class ProductEntityTest extends JpaBaseEntity {
    ...
    @Test
    void product_added_with_negative_price_throws_exception() {
        //----Act
    ...
    @Test
    void product_updated_with_negative_price_throws_exception() {
        //----Arrange
        doTransaction(em -> {
            Category cat = em.merge(category1);
            Seller seller = em.merge(seller2);
