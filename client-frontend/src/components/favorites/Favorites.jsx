function Favorites(){
    ...
    return(
        ...
        <div className="h-screen pt-10">
            ...
            <h1 className="mb-10 text-center text-2xl font-bold dark:text-white">Favorites</h1>

            <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
                <div className="rounded-lg md:w-2/3">
                    <div className="justify-between mb-6 rounded-2xl dark:bg-[#192235] p-6 shadow-md sm:flex sm:justify-start">
                        ...
                        <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                            <div className="mt-5 sm:mt-0">
                                <h2 className="text-lg font-bold text-gray-900 dark:text-white">Nike Air Max 2019</h2>
                                <p className="mt-1 text-xs text-gray-700 dark:text-gray-200">36EU - 4US</p>
                            </div>
                            <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                                ...
                                <div className="flex items-center space-x-4">
                                    <p className="text-sm">259.00 RON</p>
