...
const StarReviewsReadOnly = ({rating, numReviews, isRatingDisplayed}) => {
            ...
            {isRatingDisplayed ? (
                    <div>
                        <div className="flex">
                            ...
                            <p className="ml-2 text-sm font-medium text-zinc-500 dark:text-zinc-400">{rating.toFixed(2)} out
                                of 5</p>
                        </div>
